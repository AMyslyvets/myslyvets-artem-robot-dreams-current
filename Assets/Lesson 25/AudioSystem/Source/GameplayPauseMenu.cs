...
{
    /// <summary>
    /// In order to add settings to GameplayMenu, GameplayPauseMenu is introduced
    /// Almost a copy of GameplayMenu
    /// Created as separate class instead of rewriting GameplayMenu in order to preserve materials for each lesson
    /// </summary>
